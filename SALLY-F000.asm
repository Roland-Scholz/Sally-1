...
; 
0000 c31bf0    jp      0f01bh
0003 c3def3    jp      0f3deh
0006 c335f6    jp      0f635h
0009 c340f6    jp      0f640h
000c c350f6    jp      0f650h
000f c322f0    jp      0f022h
0012 c3dcf4    jp      0f4dch
0015 c3ebf4    jp      0f4ebh
0018 c315f6    jp      0f615h
001b f3        di      
001c af        xor     a
001d d352      out     (52h),a
...
036b cd89f3    call    0f389h
036e c5        push    bc
036f 017c92    ld      bc,927ch
0372 db40      in      a,(40h)
0374 cb47      bit     0,a
0376 280a      jr      z,0382h          ; (+0ah)
0378 cd8bf3    call    0f38bh
037b 0b        dec     bc
037c 78        ld      a,b
037d b1        or      c
037e 20f2      jr      nz,0372h         ; (-0eh)
0380 3e10      ld      a,10h
0382 47        ld      b,a
...
0640 cd35f6    call    0f635h
0643 28fb      jr      z,0640h          ; (-05h)
0645 2a33f6    ld      hl,(0f633h)
0648 7e        ld      a,(hl)
0649 2c        inc     l
064a cba5      res     4,l
...
0650 3a12ff    ld      a,(0ff12h)
0653 feee      cp      0eeh
0655 38f9      jr      c,0650h          ; (-07h)
0657 79        ld      a,c
0658 e67f      and     7fh
065a e25ff6    jp      po,0f65fh
065d f680      or      80h
065f 3256f5    ld      (0f556h),a
0662 3e47      ld      a,47h
...
06f0 00        nop     
06f1 3d        dec     a
06f2 c2f1f6    jp      nz,0f6f1h
06f5 db70      in      a,(70h)
06f7 17        rla     
06f8 cb1a      rr      d
06fa 10f0      djnz    06ech            ; (-10h)
06fc 42        ld      b,d
06fd 72        ld      (hl),d
06fe 23        inc     hl
06ff 7c        ld      a,h
...
070e db80      in      a,(80h)
0710 b7        or      a
0711 20ce      jr      nz,06e1h         ; (-32h)
0713 1b        dec     de
0714 7a        ld      a,d
0715 b3        or      e
0716 20f6      jr      nz,070eh         ; (-0ah)
0718 c9        ret     
...
0769 f3        di      
076a cdd9f6    call    0f6d9h
076d fb        ei      
076e 30f6      jr      nc,0766h         ; (-0ah)
0770 2afec2    ld      hl,(0c2feh)
0773 11e680    ld      de,80e6h
0776 b7        or      a
0777 ed52      sbc     hl,de
0779 cadef3    jp      z,0f3deh
077c 3e03      ld      a,03h
077e 3233ff    ld      (0ff33h),a
0781 3e38      ld      a,38h
0783 3288f1    ld      (0f188h),a
0786 db50      in      a,(50h)
0788 cb5f      bit     3,a
078a 2005      jr      nz,0791h         ; (+05h)
078c 3eff      ld      a,0ffh
078e 3223f8    ld      (0f823h),a
0791 21e1f7    ld      hl,0f7e1h
0794 2219f0    ld      (0f019h),hl
